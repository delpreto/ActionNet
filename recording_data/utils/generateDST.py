...
# design_dir = '.'
design_dir = os.path.join(script_dir, '..', '..', '..', 'designs')

# svg_filename = 'conductive_patch_border.svg'
# svg_filename = 'conductive_patch_fastening.svg'
# svg_filename = 'embroidery_sensor_matrix.svg'
svg_filename = os.path.join('tests', 'Manus_Glove_V4_fingers.svg')
# svg_filename = os.path.join('tests', 'test_pattern_1path.svg')
# svg_filename = os.path.join('tests', 'test_pattern_2paths.svg')
# svg_filename = os.path.join('tests', 'test_pattern_2paths_skewed.svg')
# svg_filename = os.path.join('tests', 'test_pattern_3paths.svg')
# svg_filename = os.path.join('tests', 'test_pattern_allPaths.svg')

svg_filepath = os.path.realpath(os.path.join(design_dir, svg_filename))

# Specify where to save the output DST file.
output_dir = os.path.realpath(os.path.join(design_dir, 'generated_dst_files'))
